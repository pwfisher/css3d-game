  ...
  var LEVEL = {
    ...
    MAP: {
      ...
      NODES: {
        ...
        "wall-2": {
          type: "dungeon-wall-1",
          connected: [{ id: "wall-2b", source: 1, target: 3 }],
        },
        ...
        "wall-6": {
          type: "dungeon-wall-small-3",
          connected: [{ id: "wall-cell-1", source: 1, target: 1 }],
        },
        ...
        "wall-corner-1": {
          ...
          z: 0,
          brightness: 3,
          img: "3d/level-04/wall-dungeon-cell-door.png",
          clss: "no-pntr",
          alpha: true,
          alpha_mask: 1,
        },
        ...
        "wall-door": {
          type: "dungeon-wall-4",
          img: "3d/level-04/wall-dungeon_door_lossy.jpg",
        },
        ...
        "wall-cell-1": {
          type: "dungeon-wall-cell-2",
          alpha: true,
          alpha_mask: 1,
          connected: [{ id: "wall-cell-2", source: 3, target: 1 }],
        },
        "wall-cell-2": {
          type: "dungeon-wall-cell-2",
          clss: "no-pntr",
            ...
            if (GAME.State.flags.lvl4.soporVisible) {
              ...
              if (GAME.State.flags.lvl4.soporBowl === 1) {
                ...
                if (!GAME.State.flags.lvl4.soporBowl) {
                  ...
                  GAME.ACTIONS.SetText("sopor", 7, function () {
                    GAME.ACTIONS.DialogAsk("sopor", 8, 0, function (
                      choice,
                      html
                    ) {
                      if (choice === 1) {
              ...
              GAME.ACTIONS.SetText("sopor", 0, function () {
                ...
                GAME.ACTIONS.SetText("sopor", 1, function () {
                  GAME.ACTIONS.DialogAsk("sopor", 2, 0, function (
                    choice,
                    html
                  ) {
                    if (choice === 1) {
                    ...
                    var rot = GAME.UTILS.RotateCameraTo(
                      GAME.LEVEL.MAP.NODES["wall-corner-1"].centroid
                    );
                    ...
                    GAME.ACTIONS.SetText("sopor", 3, function () {
                      ...
                      setTimeout(function () {
                        ...
                        GAME.LEVEL.MAP.NODES["sopor-1"].el.style.opacity =
                          "0.46";
                      }, 520);
        ...
        "ceil-1": {
          ...
          useval: "dirty",
          type: "dungeon-ceil-1",
          img: "3d/level-04/dungeon-ceiling-2_grate_lossy.png",
          alpha: true,
          alpha_mask: 1,
          connected: [
...
*/
        ...
        "trigger-3": {
          ...
          onchange: function (side) {
            if (this.act) {
              ...
              if (
                side === 1 &&
                GAME.State.flags.lvl4.soporVisible &&
                !GAME.State.flags.lvl4.soporBowl
              ) {
                if (
                  GAME.UTILS.IsVisible(GAME.LEVEL.MAP.NODES["sopor-1"]) &&
                  (Math.random() * 6) >> 0 !== 5
                ) {
                  return;
                }
        ...
        "trigger-4": {
          ...
          onchange: function (side) {
            if (this.act) {
              if (
                GAME.State.flags.lvl4.soporVisible &&
                !GAME.State.flags.lvl4.soporBegs
              ) {
                ...
                if (
                  bowl.icon.indexOf("dirty") > 0 ||
                  bowl.icon.indexOf("pure") > 0
                ) {
      ...
      SOUNDS: {
        ...
        "sound-metal-roll-1": {
          path: "3d/sound/metal-roll-1.mp3",
          volume: 0.3,
          loop: false,
        },
        "sound-breath-1": {
          path: "3d/sound/breathing-1.mp3",
          volume: 0.1,
          loop: true,
        },
      },
    ...
    TXT: {
      ...
      sopor: [
        // 0
        [
          "An old, rusty prison door with multiple locks. It seems impossible to open,",
          "and you have no desire to do so.",
        ...
        [
          ...
          "You try to talk to her but she ignores you, she just mumbles prayers ",
        ...
        [
          ...
          "The old lady acknowledges your presence.",
          "~Water... give me water~",
        ],
        ...
        [
          ...
          "snatch the bowl of water from your hands.",
          "The sound of slurping, sipping and laughter echoes from the bowels of the cells.",
        ],
        // 11
        [
