      ...
      geom: [
        ...
        },
        {
          ...
          shape_args: [
            ...
            15,
            false,
            new Vector(-15 * 2 - 15 / 2, -15 * 2 - 15 / 2, 0),
            "middle",
            "rotateY(90deg) rotateX(90deg)",
          ],
        },
        ...
        },
        {
          ...
          shape_args: [
            ...
            15,
            false,
            new Vector(-15 * 3 - 15 / 2, -15 * 3 - 15 / 2, 0),
            "middle",
            "rotateY(90deg) rotateX(90deg)",
          ],
        },
        ...
        },
        {
          ...
          shape_args: [
            ...
            15,
            false,
            new Vector(-15 * 4 - 15 / 2, -15 * 4 - 15 / 2, 0),
            "middle",
            "rotateY(90deg) rotateX(90deg)",
          ],
        },
        ...
        },
        {
          ...
          shape_args: [
            ...
            15,
            false,
            new Vector(-15 * 5 - 15 / 2, -15 * 5 - 15 / 2, 0),
            "middle",
            "rotateY(90deg) rotateX(90deg)",
          ],
        },
        ...
        },
        {
          ...
          shape_args: [
            ...
            15,
            false,
            new Vector(-15 * 6 - 15 / 2, -15 * 6 - 15 / 2, 0),
            "middle",
            "rotateY(90deg) rotateX(90deg)",
          ],
        },
        ...
        },
        {
          ...
          shape_args: [
            ...
            15,
            false,
            new Vector(-15 * 7 - 15 / 2, -15 * 7 - 15 / 2, 0),
            "middle",
            "rotateY(90deg) rotateX(90deg)",
          ],
        },
        ...
        },
        {
          ...
          shape_args: [
            ...
            15,
            false,
            new Vector(-15 * 8 - 15 / 2, -15 * 8 - 15 / 2, 0),
            "middle",
            "rotateY(90deg) rotateX(90deg)",
          ],
        },
        ...
        },
        {
          ...
          shape_args: [
            ...
            15,
            false,
            new Vector(-15 * 9 - 15 / 2, -15 * 9 - 15 / 2, 0),
            "middle",
            "rotateY(90deg) rotateX(90deg)",
          ],
        },
        ...
        },
        {
          ...
          shape_args: [
            ...
            15,
            false,
            new Vector(-15 * 10 - 15 / 2, -15 * 10 - 15 / 2, 0),
            "middle",
            "rotateY(90deg) rotateX(90deg)",
          ],
        },
        ...
        },
        {
          ...
          shape_args: [
            ...
            15,
            false,
            new Vector(-15 * 11 - 15 / 2, -15 * 11 - 15 / 2, 0),
            "middle",
            "rotateY(90deg) rotateX(90deg)",
          ],
        },
  ...
  var LEVEL = {
    ...
    MAP: {
      ...
      NODES: {
        ...
        "floor-0": {
          type: "dungeon-floor-1-h150",
          connected: [{ id: "door-0", source: 1, target: 2 }],
        },
        ...
        "floor-b": {
          type: "dungeon-floor-1-h175",
          connected: [{ id: "floor-3", source: 0, target: 2 }],
        },
        "floor-c": {
          type: "dungeon-floor-1-h175",
          connected: [{ id: "wall-sto-left-1", source: 2, target: 2 }],
        },
        ...
        "ramp-1": {
          type: "ramp-water-1",
          connected: [{ id: "floor-a", source: 0, target: 1 }],
        },

        "wall-left-1": {
          type: "dungeon-wall-2-h260",
          connected: [
        ...
        "wall-left-0": {
          type: "dungeon-wall-2-h260",
          connected: [{ id: "wall-left-0-ceil", source: 0, target: 2 }],
        },
        "wall-right-0": {
          type: "dungeon-wall-4-h260",
          connected: [{ id: "wall-right-0-ceil", source: 0, target: 2 }],
        },

        "wall-sto-left-1": {
          type: "dungeon-wall-2",
          connected: [{ id: "wall-sto-left-2", source: 3, target: 1 }],
        },
        "wall-sto-left-2": {
          type: "dungeon-wall-2-w180",
          connected: [{ id: "floor-6", source: 2, target: 2 }],
        },
        ...
        "wall-sto-main-1": {
          type: "dungeon-wall-3",
          img: "3d/level-05/wine-rack-2.jpg",
        },
        ...
        "floor-6": {
          type: "dungeon-floor-1-h175-w180",
          connected: [
        ...
        "ceil-2": {
          type: "dungeon-ceil-1",
          connected: [{ id: "ceil-4", source: 3, target: 1 }],
        },
        ...
        "barrel-5": {
          ...
          cast_shadow: true,
          transform:
            "translate3d(-835px, -10px, 25px) rotateX(90deg) rotateZ(90deg)",
        },
        ...
        "barrel-6": {
          ...
          cast_shadow: true,
          transform:
            "translate3d(-835px, -10px, -130px) rotateX(90deg) rotateZ(90deg)",
        },
      ...
      LIGHTS: {
        ...
        "light-hang-focus": {
          ...
          z: -440,
          intensity: 2,
          color: { r: 160, g: 40, b: 30 },
          shadow: 1,
          max_distance: 460,
          drawIcon: 1,
          active: 1,
          spot: 1,
          target: new Vector(-525, -0, -520),
          radius: 400,
        }, // active 1
        "light-barrel": {
          x: -440,
          ...
          z: -80,
          intensity: 1.25,
          color: { r: 80, g: 80, b: 240 },
          shadow: 1,
          max_distance: 500,
          drawIcon: 1,
          active: 1,
          spot: 1,
          target: new Vector(-404, 0, -50),
          radius: 910,
        },
        "light-torch": {
          x: -480,
      ...
      SOUNDS: {
        ...
        "sound-music-1": {
          path: "3d/sound/church-organ-main.mp3",
          volume: 0.1,
          loop: false,
        },
      },
      ...
      intro: [
        {
          ...
          body: [
            "You reach a seemingly out of place tunnel.",
            "Among the empty cells stands an imposing reinforced gate.",
