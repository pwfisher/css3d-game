...
*/
  ...
  var LEVEL = {
    ...
    INIT: function (lvl) {
      ...
      if (skip_intro) {
        scenestyle.perspective =
          (GAME.UTILS.Browser === "safari" ? 900 : 900 + 60) + "px";
      }
          ...
          if (brightness >= 0.999) {
            ...
            if (--blinks === 1) {
              ...
              w.requestAnimationFrame(function () {
                ...
                GAME.__render = function () {
                  scenestyle.perspective =
                    (GAME.UTILS.Browser === "safari" ? persp : persp + 60) +
                    "px";
                };
              });
                  ...
                  w.requestAnimationFrame(function () {
                    ...
                    setTimeout(function () {
                      d
                        ...
                        'Status: <i class="orange">Malnourished,</i> <i class="darkgreen">Injured</i>';
    ...
    MAP: {
      ...
      NODES: {
        ...
        "wall-1": {
          type: "dungeon-wall-1",
          connected: [{ id: "ceil-1", source: 0, target: 0 }],
        },
        ...
        "wall-corner-1": {
          ...
          tag: "div",
          clss: "dungeon-window",
          img: "3d/wall-dungeon-2-window.png",
          /*hide_frustrum:true,*/ alpha: true,
          alpha_mask: 1,
          x: 0,
          y: 0,
          z: 0,
        ...
        "wall-door": {
          ...
          alpha: true,
          alpha_mask: 1,
          img: "3d/door-dungeon-1-250x200_lossy.png",
        },
        ...
        "ceil-2": {
          type: "dungeon-ceil-1",
          connected: [{ id: "ceil-5", source: 0, target: 2 }],
        },
        ...
        "prison-food-1": {
          ...
          img: "3d/meat-3.jpg",
          transform:
            "translate3d(670px, 195px, 250px) rotateX(90deg) rotateY(-10deg)",
        ...
        "spider-1": {
          ...
          onframe: (function () {
            ...
            var angle_large = 0,
              angle_large_count = 30;
            var nomove = false,
              nomove_count = 80 + Math.random() * 100;
            var edge_count = 40;
            var old_time = 0;
            var extra = "";
            ...
            var _move = function (node, x, y, ang) {
              ...
              node.el.style.transform =
                node.transform + trns + " scale(0.28)" + extra;
            };
            ...
            return function (node, timestamp) {
              ...
              if (!LEVEL.MAP.NODES["prison-candle"].lit) {
                if (
                  --edge_count <= 0 &&
                  (left >= 240 || left <= -240 || top >= 99 || top <= -99)
                ) {
                  edge_count = 12;
            ...
            if (!GAME.INV.active_item) {
              ...
              if (LEVEL.MAP.NODES["prison-candle"].lit) {
                ...
                GAME.ACTIONS.SetText("items", 10, function () {
                  GAME.ACTIONS.DialogAsk("items", 11, 0, function (
                    choice,
                    html
                  ) {
                    if (choice === 1) {
              ...
              if (active_item.getAttribute("data-id") === "prison-bone-1") {
                ...
                GAME.ACTIONS.SetText("items", 13, function () {
                  GAME.INV.RemoveItem(
                    active_item.getAttribute("data-index") / 1
                  );
                  GAME.Sound.Play("sound-rust-1");
                  LEVEL.MAP.NODES["trapdoor-1"].open = true;
                  LEVEL.MAP.NODES["trapdoor-1"].el.style.transform =
                    "translate3d(382px, 200px, 692px) rotateX(90deg) rotateZ(20deg)";
        ...
        "prison-web-1": {
          ...
          tag: "div",
          transform:
            "translate3d(660px,-152px,750px) rotateX(45deg) rotateY(-120deg)",
          interact: function (e) {
            if (!GAME.State.control) return;
            ...
            if (GAME.INV.active_item) {
              GAME.ACTIONS.SetActiveText("items", 8, false);
              GAME.INV.Deselect();
            } else GAME.ACTIONS.SetText("items", 19);
          },
        },
            ...
            if (node.lit) {
              if (GAME.INV.active_item) {
                ...
                if (active_item.getAttribute("data-id") === "book") {
                  GAME.ACTIONS.DialogAsk("items", 1, 2, function (
                    choice,
                    html
                  ) {
                    if (choice === 1) {
                  ...
                  function () {
                    window.requestAnimationFrame(function (timestamp) {
                      ...
                      setTimeout(function () {
                        ...
                        GAME.UTILS.RebuildLight(
                          GAME.LEVEL.MAP.LIGHTS["light-1"],
                          true
                        );
                          ...
                          function () {
                            window.requestAnimationFrame(function () {
                              ...
                              GAME.ACTIONS.SetText("guard", 0, function () {
                                var centroid = GAME.LEVEL.MAP.NODES[
                                  "wall-door"
                                ].centroid.clone();
                                centroid.y -= 100;
                                ...
                                GAME.ACTIONS.SetText("guard", 1, function () {
                                  var ttr = setTimeout(function () {
                                    ...
                                    setTimeout(function () {
                                      guard_img.parentNode.removeChild(
                                        guard_img
                                      );
                                      guard_img = null;
                                    }, 2200);
      ...
      SOUNDS: {
        "sound-food-1": {
          path: "3d/sound/food-3.mp3",
          volume: 0.5,
          loop: false,
        },
        "sound-candle-1": {
          path: "3d/sound/candle-1.mp3",
          volume: 0.57,
          loop: false,
        },
        "sound-candle-2": {
          path: "3d/sound/candle-2.mp3",
          volume: 0.8,
          loop: false,
        },
        "sound-guard-1": {
          path: "3d/sound/guard-1.mp3",
          volume: 0.38,
          loop: false,
        },
        "sound-guard-2": {
          path: "3d/sound/guard-2.mp3",
          volume: 0.45,
          loop: false,
        },
        "sound-door-lock-1": {
          path: "3d/sound/door-lock.mp3",
          volume: 0.37,
          loop: false,
        },
        "sound-item-pickup-1": {
    ...
    TXT: {
      ...
      guard: [
        ...
        [
          ...
          "Why even waste good food to filth such as you... ",
          '<i class="brown">*he spits on the ground*</i>',
        ],

        // 2
        [
          "I 'd feed you to the dogs this very moment if the torturer 'd let me.",
          '<i class="darkgreen">*As he walks away, your thoughts of interacting with him are gone*</i> ',
          "You must find a way out, and soon!",
        ],
      ],
      ...
      items: [
        ...
        [
          "A bright full moon on a starless sky. My na would surely call this a terrible omen.",
        ...
        [
          ...
          "running below. As you approach, the putrid stench makes you wretch.",
          "It has been used as a lavatory.",
        ],
        ...
        // 9
        [
          "You grab the stale meat with your hands, and bite into it with great pleasure, ",
          "stopping only to let out brief gasps of relief.",
          "You cannot recognize what animal it was taken from, nor the body part, ",
          "but it is well cooked.  ", //you can taste undertones of black onions and milkweed.',
        ...
        [
          // 12
          "You try to lift the grate to no avail. Your body is weak and malnourished, ",
          "or the grate t is weld shut to the floor. perhaps both.",
        ],

        [
          // 13
          "You use the bone as a lever and lift the grate, it breaks in the process ",
          "but gives you enough leeway to drag it our of the way.",
        ],

        [
          // 14
          "The passage is dark and narrow. ",
          "Perhaps too narrow for most adults but you think you can squeeze through.",
        ],
      ...
      intro: [
        {
          ...
          body: [
            "your most recent memory, the whistling of arrows as your caravan got ",
...

        {
          ...
          body: [
            "As you move your tongue in your dry mouth, you recoil as you notice that ",
...

        {
          ...
          body: [
            "you try to make sense of your surroundings, there has to be a way out of this place.",
          ],
        },
