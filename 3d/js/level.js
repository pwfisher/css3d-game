      ...
      for (idx = MULT(h, w); idx | (0 > 0); idx = (idx - w) | 0) {
        for (
          ...
          if (((ii | 0) % 65 | 0) < 5) {
            t =
              (((((x01 | 0) + t) >> 1) & x7f) +
                (((HEAPI32[(byte_offset + i) >> 2] | 0) >> 1) & x7f)) |
              0;
          } else {
            HEAPI32[(byte_offset + i) >> 2] = t =
              (((((x01 | 0) + t) >> 1) & x7f) +
                (((HEAPI32[(byte_offset + i) >> 2] | 0) >> 1) & x7f)) |
              0;
          }
...
*/
    ...
    function applyMatrix4(x, y, z, byte_offset) {
      ...
      w =
        1.0 /
        (+HEAPF32[((byte_offset + 3) << 3) >> 3] * +x +
          +HEAPF32[((byte_offset + 7) << 3) >> 3] * +y +
          +HEAPF32[((byte_offset + 11) << 3) >> 3] * +z +
          +HEAPF32[((byte_offset + 15) << 3) >> 3]);

      HEAPF32[0 >> 3] =
        (+HEAPF32[(byte_offset << 3) >> 3] * +x +
          +HEAPF32[((byte_offset + 4) << 3) >> 3] * +y +
          +HEAPF32[((byte_offset + 8) << 3) >> 3] * +z +
          +HEAPF32[((byte_offset + 12) << 3) >> 3]) *
        +w;
      HEAPF32[8 >> 3] =
        (+HEAPF32[((byte_offset + 1) << 3) >> 3] * +x +
          +HEAPF32[((byte_offset + 5) << 3) >> 3] * +y +
          +HEAPF32[((byte_offset + 9) << 3) >> 3] * +z +
          +HEAPF32[((byte_offset + 13) << 3) >> 3]) *
        +w;
      HEAPF32[16 >> 3] =
        (+HEAPF32[((byte_offset + 2) << 3) >> 3] * +x +
          +HEAPF32[((byte_offset + 6) << 3) >> 3] * +y +
          +HEAPF32[((byte_offset + 10) << 3) >> 3] * +z +
          +HEAPF32[((byte_offset + 14) << 3) >> 3]) *
        +w;
    }
      ...
      for (y = 0; (y | 0) < (h | 0); y = (y + 1) | 0) {
        ...
        for (x = 0; (x | 0) < (w | 0); x = (x + 1) | 0) {
          ...
          if ((HEAPU8[(offset_shad + x_offset + 3) | 0] | 0) > (240 | 0)) {
            ...
            HEAPU8[(offset_rgb + x_offset) | 0] = MIN(
              255 | 0,
              ((HEAPU8[(offset_rgb + x_offset) | 0] | 0) +
                (HEAPU8[(offset_shad + x_offset) | 0] | 0)) |
                0
            );
            HEAPU8[(offset_rgb + x_offset + 1) | 0] = MIN(
              255 | 0,
              ((HEAPU8[(offset_rgb + x_offset + 1) | 0] | 0) +
                (HEAPU8[(offset_shad + x_offset + 1) | 0] | 0)) |
                0
            );
            HEAPU8[(offset_rgb + x_offset + 2) | 0] = MIN(
              255 | 0,
              ((HEAPU8[(offset_rgb + x_offset + 2) | 0] | 0) +
                (HEAPU8[(offset_shad + x_offset + 2) | 0] | 0)) |
                0
            );
            ...
            // by 15% darker
            HEAPU8[(offset_rgb + x_offset) | 0] = ~~FLOOR(
              +(HEAPU8[(offset_rgb + x_offset) | 0] | 0) * 0.85 +
                +alpha * +(HEAPU8[(offset_shad + x_offset) | 0] | 0)
            );
            HEAPU8[(offset_rgb + x_offset + 1) | 0] = ~~FLOOR(
              +(HEAPU8[(offset_rgb + x_offset + 1) | 0] | 0) * 0.85 +
                +alpha * +(HEAPU8[(offset_shad + x_offset + 1) | 0] | 0)
            );
            HEAPU8[(offset_rgb + x_offset + 2) | 0] = ~~FLOOR(
              +(HEAPU8[(offset_rgb + x_offset + 2) | 0] | 0) * 0.85 +
                +alpha * +(HEAPU8[(offset_shad + x_offset + 2) | 0] | 0)
            );
      ...
      for (y = 0; (y | 0) < (height | 0); y = (y + 1) | 0) {
        ...
        for (x = 0; (x | 0) < (width | 0); x = (x + 1) | 0) {
          ...
          if (temp > 0.01) {
            ...
            color_r =
              (color_r + ~~FLOOR(+(HEAPU8[byte_offset | 0] | 0) * temp)) | 0;
            color_g =
          ...
          if (temp > 0.01) {
            ...
            color_r =
              (color_r + ~~FLOOR(+(HEAPU8[(byte_offset + 4) | 0] | 0) * temp)) |
              0;
            color_g =
              (color_g + ~~FLOOR(+(HEAPU8[(byte_offset + 5) | 0] | 0) * temp)) |
              0;
            color_b =
              (color_b + ~~FLOOR(+(HEAPU8[(byte_offset + 6) | 0] | 0) * temp)) |
              0;
          }
          ...
          if (temp > 0.01) {
            ...
            color_r =
              (color_r + ~~FLOOR(+(HEAPU8[(byte_offset + 8) | 0] | 0) * temp)) |
              0;
            color_g =
              (color_g + ~~FLOOR(+(HEAPU8[(byte_offset + 9) | 0] | 0) * temp)) |
              0;
            color_b =
              (color_b +
                ~~FLOOR(+(HEAPU8[(byte_offset + 10) | 0] | 0) * temp)) |
              0;
          }
          ...
          if (temp > 0.01) {
            ...
            color_r =
              (color_r +
                ~~FLOOR(+(HEAPU8[(byte_offset + 12) | 0] | 0) * temp)) |
              0;
            color_g =
              (color_g +
                ~~FLOOR(+(HEAPU8[(byte_offset + 13) | 0] | 0) * temp)) |
              0;
            color_b =
              (color_b +
                ~~FLOOR(+(HEAPU8[(byte_offset + 14) | 0] | 0) * temp)) |
              0;
          }
          ...
          if (temp > 0.01) {
            ...
            color_r =
              (color_r +
                ~~FLOOR(+(HEAPU8[(byte_offset + 16) | 0] | 0) * temp)) |
              0;
            color_g =
              (color_g +
                ~~FLOOR(+(HEAPU8[(byte_offset + 17) | 0] | 0) * temp)) |
              0;
            color_b =
              (color_b +
                ~~FLOOR(+(HEAPU8[(byte_offset + 18) | 0] | 0) * temp)) |
              0;
          }
          ...
          if (temp > 0.01) {
            ...
            color_r =
              (color_r +
                ~~FLOOR(+(HEAPU8[(byte_offset + 20) | 0] | 0) * temp)) |
              0;
            color_g =
              (color_g +
                ~~FLOOR(+(HEAPU8[(byte_offset + 21) | 0] | 0) * temp)) |
              0;
            color_b =
              (color_b +
                ~~FLOOR(+(HEAPU8[(byte_offset + 22) | 0] | 0) * temp)) |
              0;
          }
          ...
          if (temp > 0.01) {
            ...
            color_r =
              (color_r +
                ~~FLOOR(+(HEAPU8[(byte_offset + 24) | 0] | 0) * temp)) |
              0;
            color_g =
              (color_g +
                ~~FLOOR(+(HEAPU8[(byte_offset + 25) | 0] | 0) * temp)) |
              0;
            color_b =
              (color_b +
                ~~FLOOR(+(HEAPU8[(byte_offset + 26) | 0] | 0) * temp)) |
              0;
          }
          ...
          if (temp > 0.01) {
            ...
            color_r =
              (color_r +
                ~~FLOOR(+(HEAPU8[(byte_offset + 28) | 0] | 0) * temp)) |
              0;
            color_g =
              (color_g +
                ~~FLOOR(+(HEAPU8[(byte_offset + 29) | 0] | 0) * temp)) |
              0;
            color_b =
              (color_b +
                ~~FLOOR(+(HEAPU8[(byte_offset + 30) | 0] | 0) * temp)) |
              0;
          }
          ...
          if (temp > 0.01) {
            ...
            color_r =
              (color_r +
                ~~FLOOR(+(HEAPU8[(byte_offset + 32) | 0] | 0) * temp)) |
              0;
            color_g =
              (color_g +
                ~~FLOOR(+(HEAPU8[(byte_offset + 33) | 0] | 0) * temp)) |
              0;
            color_b =
              (color_b +
                ~~FLOOR(+(HEAPU8[(byte_offset + 34) | 0] | 0) * temp)) |
              0;
          }
      ...
      for (y = 0; (y | 0) < (height | 0); y = (y + 1) | 0) {
        ...
        for (x = 0; (x | 0) < (width | 0); x = (x + 1) | 0) {
          ...
          if ((HEAPU8[(image_offset + x_offset + 3) | 0] | 0) > 30) {
            ...
            // read values from the 3/3 entry...
            HEAPU8[(image_offset + x_offset) | 0] = MIN(255 | 0, color_r | 0);
            HEAPU8[(image_offset + x_offset + 1) | 0] = MIN(
              255 | 0,
              color_g | 0
            );
            HEAPU8[(image_offset + x_offset + 2) | 0] = MIN(
              255 | 0,
              color_b | 0
            );
            //HEAPU8[ (image_offset + x_offset + 3)|0 ] = HEAPU8[ (byte_offset + 3)|0 ];
    ...
    function AsmLightApply(byte_offset) {
      ...
      shadow_offset =
        (2097152 - MULT(MULT(width | 0, height | 0) | 0, 4 | 0)) | 0;
        ...
        for (x = 0; (x | 0) < (width | 0); x = (x + 1) | 0) {
          ...
          for (k = 0; (k | 0) < (intersection_count | 0); k = (k + 1) | 0) {
            ...
            for (v = 0; (v | 0) < (triangles | 0); v = (v + 1) | 0) {
              ...
              DdN =
                +ray_direction_x * +HEAPF32[((temp_int + 9) << 3) >> 3] +
                +ray_direction_y * +HEAPF32[((temp_int + 10) << 3) >> 3] +
                +ray_direction_z * +HEAPF32[((temp_int + 11) << 3) >> 3];
              sign = 0;
              ...
              HEAPF32[8 >> 3] =
                +ray_origin_y - +HEAPF32[((temp_int + 1) << 3) >> 3];
              HEAPF32[16 >> 3] =
                +ray_origin_z - +HEAPF32[((temp_int + 2) << 3) >> 3];

              HEAPF32[24 >> 3] =
                +HEAPF32[8 >> 3] * +HEAPF32[((temp_int + 8) << 3) >> 3] -
                +HEAPF32[16 >> 3] * +HEAPF32[((temp_int + 7) << 3) >> 3];
              HEAPF32[32 >> 3] =
                +HEAPF32[16 >> 3] * +HEAPF32[((temp_int + 6) << 3) >> 3] -
                +HEAPF32[0 >> 3] * +HEAPF32[((temp_int + 8) << 3) >> 3];
              HEAPF32[40 >> 3] =
                +HEAPF32[0 >> 3] * +HEAPF32[((temp_int + 7) << 3) >> 3] -
                +HEAPF32[8 >> 3] * +HEAPF32[((temp_int + 6) << 3) >> 3];

              // var DdQxE2 = sign * ray_direction.dot( diff.cross( edge2_a ) );
              DdQxE2 =
                +(sign | 0) *
                +(
                  +ray_direction_x * +HEAPF32[24 >> 3] +
                  +ray_direction_y * +HEAPF32[32 >> 3] +
                  +ray_direction_z * +HEAPF32[40 >> 3]
                );
              QdN = 0.0;
              DdE1xQ = 0.0;
              ...
              if ((intersects | 0) == (1 | 0)) {
                if (+DdQxE2 < 0.0) {
                  ...
                  HEAPF32[24 >> 3] =
                    +HEAPF32[((temp_int + 4) << 3) >> 3] * +HEAPF32[16 >> 3] -
                    +HEAPF32[((temp_int + 5) << 3) >> 3] * +HEAPF32[8 >> 3];
                  HEAPF32[32 >> 3] =
                    +HEAPF32[((temp_int + 5) << 3) >> 3] * +HEAPF32[0 >> 3] -
                    +HEAPF32[((temp_int + 3) << 3) >> 3] * +HEAPF32[16 >> 3];
                  HEAPF32[40 >> 3] =
                    +HEAPF32[((temp_int + 3) << 3) >> 3] * +HEAPF32[8 >> 3] -
                    +HEAPF32[((temp_int + 4) << 3) >> 3] * +HEAPF32[0 >> 3];
                  ...
                  if (+DdE1xQ < 0.0) {
                    ...
                    if (+DdQxE2 + +DdE1xQ > +(DdN + 1.0)) {
                      // DdQxE2 + DdE1xQ - DdN > 1 && DdQxE2 + DdE1xQ - DdN < 300) // DdQxE2 + DdE1xQ > DdN )
                      intersects = 0;
                      continue;
                    } else {
                      QdN =
                        ...
                        +(
                          +HEAPF32[0 >> 3] *
                            +HEAPF32[((temp_int + 9) << 3) >> 3] +
                          +HEAPF32[8 >> 3] *
                            +HEAPF32[((temp_int + 10) << 3) >> 3] +
                          +HEAPF32[16 >> 3] *
                            +HEAPF32[((temp_int + 11) << 3) >> 3]
                        );
              ...
              if ((intersects | 0) == (1 | 0)) {
                ...
                temp =
                  5.0 +
                  +SQRT(
                    +HEAPF32[0 >> 3] * +HEAPF32[0 >> 3] +
                      +HEAPF32[8 >> 3] * +HEAPF32[8 >> 3] +
                      +HEAPF32[16 >> 3] * +HEAPF32[16 >> 3]
                  );
      ...
      for (var i = 0; i < LIT_NODES.length; ++i) {
        ...
        if (lit.face_camera) {
          ...
          if (Math.abs(vv.x) < 1.01 && vv.z < 1.0001) {
            dist_camera = subv
              .subtractReuse(lit.centroid, GAME.DIMS.pos)
              .length();
          ...
          // ####
          if (GAME.LEVEL.BEACON && lit.beacon) {
            // !== GAME.LEVEL.beacon)
          ...
          if (
            !visible &&
            (dist < lit_dist_min || (vv.x < 1.12 && vv.y < 1.1))
          ) {
            if (lit.vertices) {
          ...
          if (visible && lit.hide_frustrum > 1) {
            if (dist > 1040) {
              // if we are far, but not too far to be removed. Mark us as inactive
              var frustrum_cb = GAME.LEVEL.MAP.FRUSTRUM[lit.hide_frustrum];
              if (frustrum_cb) frustrum_cb(lit, 0);
            } else {
              // activate us back!
  ...
  function _InitNodeWorld(node, type) {
    ...
    var w = type.shadow_w || SHADOW_W,
      h = type.shadow_h || SHADOW_H;
    var c, ctx;
    ...
    if (!node.use && type.use) {
      ...
      if (!node.useval && type.useval) node.useval = type.useval;
    }
    if (node.use) {
      el.setAttribute("data-use", node.use);
      if (node.useval) el.setAttribute("data-useval", node.useval);
    }
    ...
    if (!node.cast_shadow && node.cast_shadow !== false)
      node.cast_shadow = type.cast_shadow;
  ...
  GAME.UTILS.AddNode = function (node_id, gate, node) {
    ...
    _ApplyWorldConnection(
      target_node,
      target_type.connections[conn_target],
      source_node,
      source_type.connections[conn_source]
    );
    ...
    for (var k in triggers) {
      ...
      if (trigger.node) {
        ...
        trigger.vertices = [
          ...
          new Vector(
            trigger.dims[0] + trigger.dims[2],
            0,
            trigger.dims[1] + trigger.dims[3]
          ),
  ...
  function _InitNodeObject(node, node_type) {
    ...
    for (var j = 0; j < gl; ++j) {
      ...
      for (var i = 0; i < geoms.length; ++i) {
        ...
        if (!geoms[i].alpha)
          geoms[i].alpha = curr_geom.alpha || node.alpha || node_type.alpha;
        if (!geoms[i].alpha_rect)
          geoms[i].alpha_rect =
            curr_geom.alpha_rect || node.alpha_rect || node_type.alpha_rect;
        if (!geoms[i].alpha_mask)
          geoms[i].alpha_mask =
            curr_geom.alpha_mask || node.alpha_mask || node_type.alpha_mask;
        if (!geoms[i].width)
          geoms[i].width = curr_geom.width || node.width || node_type.width;
        if (!geoms[i].height)
          geoms[i].height = curr_geom.height || node.height || node_type.height;
  ...
  function _makeNodeObjects(nodes) {
    ...
    for (var k in nodes) {
      ...
      if (node_type.isnew) _InitNodeObject(node, node_type);
      else _InitNodeObjectOLD(node, node_type);
        ...
        if (__node_setCameraUpdate(node)) {
          if (!node.centroid) {
            if (node.vertices && node.vertices[0]) {
              ...
              node.centroid = new Vector(
                (nv[2].x + nv[0].x) / 2,
                (nv[2].y + nv[0].y) / 2,
                (nv[2].z + nv[0].z) / 2
              );
            } else {
              var temp = node.el.style.transform
                .replace("translate3d(", "")
                .split(")")[0];
              temp = temp
                .replace("px", "")
  ...
  function _InitNodeObjectOLD(node, type) {
    ...
    for (var i = 0; i < gl; ++i) {
      ...
      if (typeof curr_geom.vertices === "function") {
        curr_geom.vertices = curr_geom.vertices(
          curr_geom.width,
          curr_geom.height
        );
      }
      ...
      if (curr_geom.hasOwnProperty("cast_shadow"))
        shadow = curr_geom.cast_shadow;
      ...
      if (!curr_geom.matrix && curr_geom.transform) {
        curr_geom.matrix = node.geom[i].matrix = _GetMatrixCSS(
          curr_geom.transform
        );
      }
  ...
  function _ApplyWorldConnection(
    target_node,
    target_con,
    source_node,
    source_con
    ...
    for (var k = 0; k < target_type.vertices.length; ++k) {
      target_node.vertices[k] = new Vector(
        target_type.vertices[k].x + x,
    ...
    if (!target_node.walk)
      target_node.angle = _angle(
        target_node.vertices[0],
        target_node.vertices[1]
      );

    target_node.centroid = new Vector(
      (target_node.vertices[2].x + target_node.vertices[0].x) / 2,
  ...
  GAME.UTILS.AddLight = function (id, light) {
    if (!light || !id) {
      console.log(
        "{x:340, y:60, z:66, intensity:1, color:{r:60,g:60,b:220}, shadow:1, max_distance:570, drawIcon:1, active:1}"
      );
      return;
    }
  ...
  GAME.UTILS.RebuildLight = function (light, force) {
    if (light.el && light.drawIcon) {
      ...
      light.el.style.transform =
        "translate3d(" + light.x + "px, " + light.y + "px, " + light.z + "px)";
    }
  ...
  function makeLights(lvlmap, nodes, timeout) {
    ...
    for (var k in lvlmap.LIGHTS) {
      ...
      for (var i = 0; i < nodes.length; ++i) makeLightForNode(light, nodes[i]);
      // ----
    }

    if (timeout === -1) {
      for (var i = 0; i < nodes.length; ++i) _RenderLight(nodes[i], true);
    } else {
  ...
  c_light_rescale.width = 3;
  c_light_rescale.height = 3;
  ...
  c_light_rescale2.width = SHADOW_W;
  c_light_rescale2.height = SHADOW_H;
  var ctx_lr_large = c_light_rescale2.getContext("2d", { alpha: false });

  var c_shadow = d.createElement("canvas");
  c_shadow.width = SHADOW_W;
  c_shadow.height = SHADOW_H;
  ...
  function makeLightForNode(light, node, affected_only) {
    ...
    if (light.spot) {
      ...
      var cone_dist = node.centroid
        .subtract(light.direction)
        .dot(light.cone_dir);
      var cone_radius = (cone_dist / light.max_distance) * light.radius;
      if (light.max_radius)
        cone_radius = Math.min(light.max_radius, cone_radius);

      var len = node.centroid
        .subtract(light.direction)
        .subtract(light.cone_dir.multiply(cone_dist))
        .length();
      if (len > cone_radius) {
        half_dist = 0;
        ...
        if (light.inner_radius) {
          ...
          if (len < inner_scale) half_dist = 1;
            ...
            half_dist = 1 - (len - inner_scale) / (cone_radius - inner_scale);
        } else half_dist = 1 - len / cone_radius;
      ...
      if (len > cone_radius) {
        ...
        } else dist_v1 = 1 - len / cone_radius;
      ...
      if (len > cone_radius) {
        ...
        } else dist_v2 = 1 - len / cone_radius;
      ...
      if (len > cone_radius) {
        ...
        } else dist_v3 = 1 - len / cone_radius;
      ...
      if (len > cone_radius) {
        ...
        } else dist_v4 = 1 - len / cone_radius;
    ...
    var theta1 = -(
      v1_normal.dot(light_dir.subtract(v1_a).unit()) * light.intensity
    );
    var theta2 = -(
      v2_normal.dot(light_dir.subtract(v2_a).unit()) * light.intensity
    );
    var theta3 = -(
      v3_normal.dot(light_dir.subtract(v3_b).unit()) * light.intensity
    );
    var theta4 = -(
      v4_normal.dot(light_dir.subtract(v1_b).unit()) * light.intensity
    );
    ...
    var half_theta = -(
      node.vertexNormals[4].dot(light_dir.subtract(half_point).unit()) *
      light.intensity
    );
    ...
    */
    ...
    c_img_lr.data[4] =
      ((light_val_04 + light_val_03 + half_light_val * 0) / 2) * light.color.r;
    c_img_lr.data[5] =
      ((light_val_04 + light_val_03 + half_light_val * 0) / 2) * light.color.g;
    c_img_lr.data[6] =
      ((light_val_04 + light_val_03 + half_light_val * 0) / 2) * light.color.b;
    c_img_lr.data[7] = 255;
    ...
    c_img_lr.data[12] =
      ((light_val_04 + light_val_01 + half_light_val * 0) / 2) * light.color.r;
    c_img_lr.data[13] =
      ((light_val_04 + light_val_01 + half_light_val * 0) / 2) * light.color.g;
    c_img_lr.data[14] =
      ((light_val_04 + light_val_01 + half_light_val * 0) / 2) * light.color.b;
    ...
    c_img_lr.data[20] =
      ((light_val_03 + light_val_02 + half_light_val * 0) / 2) * light.color.r;
    c_img_lr.data[21] =
      ((light_val_03 + light_val_02 + half_light_val * 0) / 2) * light.color.g;
    c_img_lr.data[22] =
      ((light_val_03 + light_val_02 + half_light_val * 0) / 2) * light.color.b;
    ...
    c_img_lr.data[28] =
      ((light_val_01 + light_val_02 + half_light_val * 0) / 2) * light.color.r;
    c_img_lr.data[29] =
      ((light_val_01 + light_val_02 + half_light_val * 0) / 2) * light.color.g;
    c_img_lr.data[30] =
      ((light_val_01 + light_val_02 + half_light_val * 0) / 2) * light.color.b;
      ...
      */
      ...
      if (DEBUG) {
        debug_ctx = (function (node) {
          ...
          cc.style.cssText =
            "position:relative;margin:0px;z-index:99999;background:black;transform:scale(1);";
      ...
      for (var j in LEVEL.ACTIVE_MAP) {
        ...
        if (
          half_point_curr
            .subtract(light_dir)
            .dot(half_point_new.subtract(light_dir)) < 0
        ) {
          continue;
        }

        var ang = Vector.angleBetween(
          curr_node.vertexNormals[4],
          node.vertexNormals[4]
        );
        if (ang > 2.0 && Math.abs(ang - 3.141592653589793) > 0.001) {
          // ang !== 3.141592653589793 )
          continue;
        }

        if (
          half_point_curr.subtract(light_dir).length() - 1 >
          half_point_new.subtract(light_dir).length()
        ) {
          continue;
        }
      ...
      if (ordered.length === 0) {
        if (node.light_data) {
          ...
          node.light_data = new Uint8ClampedArray(ASM_HEAP, img_offset).slice(
            0
          );
          node.light_ctx.putImageData(
            new ImageData(node.light_data, w, h),
            0,
            0
          );
      ...
      heap.set(
        [
          node.triangles[0].points[0].x,
          node.triangles[0].points[0].y,
          node.triangles[0].points[0].z,
          node.triangles[0].points[1].x,
          node.triangles[0].points[1].y,
          node.triangles[0].points[1].z,
          node.triangles[0].points[2].x,
          node.triangles[0].points[2].y,
          node.triangles[0].points[2].z,
        ],
        132
      );
      heap.set(
        [
          node.triangles[0].point_edge.x,
          node.triangles[0].point_edge.y,
          node.triangles[0].point_edge.z,
        ],
        141
      );
      heap.set(
        [
          node.triangles[0].edge1.x,
          node.triangles[0].edge1.y,
          node.triangles[0].edge1.z,
        ],
        144
      );
      heap.set(
        [
          node.triangles[0].edge2.x,
          node.triangles[0].edge2.y,
          node.triangles[0].edge2.z,
        ],
        147
      );
      heap.set(
        [
          node.triangles[0].normal.x,
          node.triangles[0].normal.y,
          node.triangles[0].normal.z,
        ],
        150
      );
      ...
      if (!node.tri) {
        heap.set(
          [
            node.triangles[1].points[0].x,
            node.triangles[1].points[0].y,
            node.triangles[1].points[0].z,
            node.triangles[1].points[1].x,
            node.triangles[1].points[1].y,
            node.triangles[1].points[1].z,
            node.triangles[1].points[2].x,
            node.triangles[1].points[2].y,
            node.triangles[1].points[2].z,
          ],
          153
        );
        heap.set(
          [
            node.triangles[1].point_edge.x,
            node.triangles[1].point_edge.y,
            node.triangles[1].point_edge.z,
          ],
          162
        );
        heap.set(
          [
            node.triangles[1].edge1.x,
            node.triangles[1].edge1.y,
            node.triangles[1].edge1.z,
          ],
          165
        );
        heap.set(
          [
            node.triangles[1].edge2.x,
            node.triangles[1].edge2.y,
            node.triangles[1].edge2.z,
          ],
          168
        );
        heap.set(
          [
            node.triangles[1].normal.x,
            node.triangles[1].normal.y,
            node.triangles[1].normal.z,
          ],
          171
        );
      }
      ...
      for (var jj = 0; jj < ordered.length; ++jj) {
        ...
        if (obst.alpha_mask === 1) {
          ...
          if (immg) {
            ...
            var img_data = type_ctx.getImageData(0, 0, obst.width, obst.height)
              .data;
        ...
        heap.set(
          [
            obst.triangles[0].points[0].x,
            obst.triangles[0].points[0].y,
            obst.triangles[0].points[0].z,
            obst.triangles[0].points[1].x,
            obst.triangles[0].points[1].y,
            obst.triangles[0].points[1].z,
            obst.triangles[0].points[2].x,
            obst.triangles[0].points[2].y,
            obst.triangles[0].points[2].z,
          ],
          offset + 100
        );
        heap.set(
          [
            obst.triangles[0].point_edge.x,
            obst.triangles[0].point_edge.y,
            obst.triangles[0].point_edge.z,
          ],
          offset + 109
        );
        heap.set(
          [
            obst.triangles[0].edge1.x,
            obst.triangles[0].edge1.y,
            obst.triangles[0].edge1.z,
          ],
          offset + 112
        );
        heap.set(
          [
            obst.triangles[0].edge2.x,
            obst.triangles[0].edge2.y,
            obst.triangles[0].edge2.z,
          ],
          offset + 115
        );
        heap.set(
          [
            obst.triangles[0].normal.x,
            obst.triangles[0].normal.y,
            obst.triangles[0].normal.z,
          ],
          offset + 118
        );
        ...
        if (!obst.tri) {
          heap.set(
            [
              obst.triangles[1].points[0].x,
              obst.triangles[1].points[0].y,
              obst.triangles[1].points[0].z,
              obst.triangles[1].points[1].x,
              obst.triangles[1].points[1].y,
              obst.triangles[1].points[1].z,
              obst.triangles[1].points[2].x,
              obst.triangles[1].points[2].y,
              obst.triangles[1].points[2].z,
            ],
            offset + 121
          );
          heap.set(
            [
              obst.triangles[1].point_edge.x,
              obst.triangles[1].point_edge.y,
              obst.triangles[1].point_edge.z,
            ],
            offset + 130
          );
          heap.set(
            [
              obst.triangles[1].edge1.x,
              obst.triangles[1].edge1.y,
              obst.triangles[1].edge1.z,
            ],
            offset + 133
          );
          heap.set(
            [
              obst.triangles[1].edge2.x,
              obst.triangles[1].edge2.y,
              obst.triangles[1].edge2.z,
            ],
            offset + 136
          );
          heap.set(
            [
              obst.triangles[1].normal.x,
              obst.triangles[1].normal.y,
              obst.triangles[1].normal.z,
            ],
            offset + 139
          );
        }
...
*/
      ...
      var rgba_data = new Uint8ClampedArray(
        ASM_HEAP,
        ASM_HEAP.byteLength - 16900
      );
      var sad = rgba_data;
  ...
  function _RenderLight(node, fast_compute) {
    ...
    (function (node, fast_compute) {
      ...
      var draw_image = function () {
        ...
        } else type_ctx = type_canvas.getContext("2d", { alpha: true });
        ...
        if (!node.bg) {
          ...
          if (node.decal) {
            ...
            type_ctx.drawImage(
              GAME.LEVEL.PRELOAD_IMG[node.decal],
              0,
              0,
              dcl.naturalWidth,
              dcl.naturalHeight,
          ...
          type_ctx.drawImage(
            ...
            0,
            0,
            node.light_map.width,
            node.light_map.height,
            0,
            0,
            w,
            h
        ...
        if (node.alpha) {
          ...
          if (node.alpha_mask) {
            ...
            type_ctx.drawImage(
              node.alpha_mask === 1 ? this : node.alpha_mask,
              0,
              0,
              w,
              h
          ...
          if (false && type_canvas.toBlob) {
            ...
            type_canvas.toBlob(
              function (blob) {
                ...
                if (node.tag === "img") node.el.src = tmp_path;
                else
                  node.el.style.background =
                    "url(" + tmp_path + ") 0 0 / 100% 100% no-repeat";
            ...
            if (node.tag === "img")
              ...
              node.el.style.background =
                "url(" +
                type_canvas.toDataURL("image/png", quality) +
          ...
          if (!fast_compute && type_canvas.toBlob) {
            ...
            if (node.tag === "img")
              ...
              node.el.style.background =
                "url(" +
                type_canvas.toDataURL("image/jpeg", quality) +
                ") 0 0 / 100% 100% no-repeat";
      ...
      // -------
      var src = "";
      if (DEBUG) src = "3d/debug_square.jpg";
      else src = node.img || node_type.img;
