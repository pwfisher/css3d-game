(function (w, d, GAME) {
  ...
  var LEVEL = {
    ...
    INIT: function (lvl) {
      ...
      if (GAME.LEVEL.MOVE.splash) {
        GAME.Sound.SetSteps("water-step-1", "water-step-2", {
          chance: 0.82,
          sounds: [
            { chance: 0.0, sound: "water-step-3" },
            { chance: 0.55, sound: "water-step-4" },
          ],
        });
        GAME.LEVEL.BEACON = "1";
      } else {
      ...
      var __MAKE_3D = function () {
        ...
        window.cube = new THREE.Mesh(
          new THREE.CubeGeometry(340, 300, 30),
        ...
        for (var k in GAME.LEVEL.MAP.LIGHTS) {
          ...
          var rgb =
            light.color.b | (light.color.g << 8) | (light.color.r << 16);
          rgb = "#" + (0x1000000 + rgb).toString(16).slice(1);

          var lightsource = new THREE.PointLight(
            rgb,
            light.intensity,
            light.max_distance
          );
    ...
    MAP: {
      ...
      NODES: {
          ...
          interact: function (e) {
            ...
            if (GAME.INV.active_item) {
              ...
              if (act_item.getAttribute("data-id") !== "stick-torch") {
                ...
                GAME.ACTIONS.DialogAsk("doortorch", 1, 0, function (
                  choice,
                  html
                ) {
                  if (choice === 1) {
                  ...
                  setTimeout(function () {
                    ...
                    torch_node.el.style.transform =
                      "translate3d(-659px, 85px, 2544px) rotateZ(90deg) rotateZ(-60deg)";
        ...
        "floor-4": {
          ...
          beacon: ["1", "2"],
          beacon_dist: 2000,
          connected: [{ id: "floor-5", source: 2, target: 0 }],
        },
        ...
        "floor-bg-1": {
          ...
          hide_frustrum: 2,
          beacon: ["1"],
          connected: [{ id: "floor-bg-2", source: 0, target: 2 }],
        },
        "floor-bg-2": {
          type: "cave-water-1b",
          hide_frustrum: 1,
          beacon: ["1"],
          img: "3d/out_lighter_single.gif",
        },
        "wall-1": {
          type: "cave-wall-1-w340",
          hide_frustrum: 1,
          alpha: true,
          alpha_mask: 1,
          brightness: 8,
        ...
        "wall-4b": {
          type: "cave-wall-2b",
          decal: "3d/level-2/wall-moss.png",
          hide_frustrum: 1,
          beacon: ["1"],
          connected: [{ id: "wall-4c", source: 3, target: 1 }],
        },
        ...
        "ceil-6": {
          type: "dungeon-ceil-1",
          hide_frustrum: 1,
          connected: [{ id: "ceil-6b", source: 0, target: 2 }],
        },
        "ceil-7": {
          type: "dungeon-ceil-2-large",
          hide_frustrum: 1,
          connected: [{ id: "ceil-8", source: 3, target: 1 }],
        },
        "ceil-8": {
          type: "dungeon-ceil-2-large",
          hide_frustrum: 1,
        ...
        "wall-knife-right-1": {
          ...
          hide_frustrum: 1,
          beacon: ["1", "2"],
          connected: [{ id: "wall-knife-right-2", source: 3, target: 1 }],
        },
        "wall-knife-right-2": {
          type: "cave-wall-1",
          hide_frustrum: 1,
          beacon: ["1"],
          connected: [{ id: "wall-knife-main", source: 3, target: 1 }],
        },
        // floor-room-path-left-1
        "wall-knife-main": {
          type: "cave-wall-3-w340",
          hide_frustrum: 1,
          beacon: ["1"],
          alpha: true,
          alpha_mask: 1,
        ...
        "wall-knife-left-1": {
          ...
          hide_frustrum: 1,
          beacon: ["1"],
          connected: [{ id: "wall-knife-left-2", source: 3, target: 1 }],
        },
        "wall-knife-left-2": {
          type: "cave-wall-4",
          hide_frustrum: 1,
        ...
        "wall-knife-w160": {
          type: "cave-wall-3-w160",
          hide_frustrum: 1,
          beacon: ["1", "2"],
          connected: [{ id: "wall-right-1", source: 3, target: 1 }],
        },
        "floor-knife-1": {
          type: "cave-water-2",
          bg: 1,
        ...
        "wall-6": {
          ...
          hide_frustrum: 1,
          beacon: ["1"],
          connected: [{ id: "wall-7", source: 1, target: 3 }],
        },
        "wall-7": {
          type: "cave-wall-3b",
          decal: "3d/level-2/wall-moss.png",
          hide_frustrum: 1,
          beacon: ["1"],
          connected: [{ id: "wall-7b", source: 1, target: 3 }],
        },
        "wall-8": {
          type: "cave-wall-2",
          hide_frustrum: 1,
        ...
        "wall-7b": {
          ...
          hide_frustrum: 1,
          beacon: ["1"],
          connected: [{ id: "wall-7c", source: 1, target: 3 }],
        },
        ...
        "decal-skeleton-1": {
          ...
          interact: function (e) {
            ...
            if (GAME.INV.active_item) {
              if (
                GAME.INV.active_item.getAttribute("data-id") !== "stick-torch"
              ) {
                GAME.ACTIONS.SetActiveText("items", 1, true, "old");
              } else {
        ...
        "decal-pile-trash-1": {
          ...
          overlay: true,
          transform:
            "translate3d(-1000px, 205px, 1220px) rotateY(120deg) rotateX(40deg)",
          vertices: [
          ...
          interact: function (e) {
            ...
            GAME.ACTIONS.SetText(
              "skeleton",
              1,
              function () {
                GAME.ACTIONS.DialogAsk("skeleton", 2, 0, function (
                  choice,
                  html
                ) {
                  if (choice === 1) {
                  ...
                  GAME.ACTIONS.SetText(
                    ...
                    3,
                    function () {
                      GAME.ACTIONS.DialogAsk("skeleton", 4, 0, function (
                        choice,
                        html
                      ) {
                        GAME.ACTIONS.DialogClose();
        ...
        "shape-rock": {
          ...
          hide_frustrum: 1,
          transform:
            "translate3d(-890px, 195px, 1310px) scale3d(2.5, 2.5, 2.5)",
        },
        ...
        "obj-torch-door-2": {
          ...
          type: "obj-torch-unlit",
          transform:
            GAME.State.flags.lvl2 && GAME.State.flags.lvl2.alchUnlock
              ? "translate3d(-659px, 85px, 2544px) rotateZ(90deg) rotateZ(-60deg)"
              : "translate3d(-500px, 244px, 2605px) rotateZ(90deg) rotateX(30deg)",
        ...
        "wall-right-1": {
          ...
          hide_frustrum: 1,
          beacon: ["1", "2"],
          connected: [{ id: "wall-right-2", source: 3, target: 1 }],
        },
        "wall-left-2": {
          type: "cave-wall-2",
          hide_frustrum: 1,
        ...
        "wall-right-2": {
          ...
          hide_frustrum: 1,
          beacon: ["1", "2"],
          connected: [{ id: "wall-room-right-1", source: 3, target: 1 }],
        },
        "wall-room-right-1": {
          type: "cave-wall-1",
          hide_frustrum: 1,
        ...
        "floor-room-1": {
          ...
          hide_frustrum: 2,
          beacon: ["1", "2"],
          connected: [{ id: "floor-room-fall-1", source: 2, target: 0 }],
        },
        "floor-room-fall-1": {
          type: "cave-water-1-fall",
          bg: 1,
          hide_fov: 1,
          hide_frustrum: 2,
          beacon: ["1", "2"],
      ...
      FRUSTRUM: {
        2: function (node, value) {
          if (!value) {
            if (!node.tmp_bg) {
              node.tmp_bg = 1;
              node.el.style.background = node.el.style.background.replace(
                "out_lighter.gif",
                "out_lighter_single.gif"
              );
            }
          } else {
            if (node.tmp_bg) {
        ...
        "trigger-1": {
          ...
          onchange: function () {
            if (this.act) {
              ...
              eyes.style.cssText =
                "position:absolute;width:36px;height:26px;transform:translate3d(220px,240px,-310px);transform-origin:50% 50%;" +
              ...
              if (this.dat && this.dat !== 1) {
                ...
                if (this.vertices[1].x < -GAME.DIMS.pos.x) {
                  ...
                  this.dat.style.transform =
                    "translate3d(-145px, 290px, -500px) rotateY(-75deg) scale(0.5)";
                  this.dat = 1;
                } else {
          ...
          onchange: function () {
                ...
                GAME.ACTIONS.SetText("leech", 1, function () {
                  ...
                  creature_move_center(function () {
                    GAME.ACTIONS.SetText("leech", 3, function () {
                      GAME.ACTIONS.DialogAsk("leech", 5, 0, function (
                        choice,
                        html
                      ) {
                        GAME.ACTIONS.DialogClose();
            ...
            creature_move_center = function (callback) {
              ...
              GAME.OnFrame(24, frames, function (times, total) {
                ...
                node.transform =
                  "translate3d(" + new_val + "px, 100px, 2590px)";
                ...
                GAME.Fire(
                  "ReqSetRot",
                  GAME.UTILS.RotateCameraTo(node.centroid)
                );
            ...
            creature_move_close = function (callback) {
              ...
              var get_angle = function (_target) {
                ...
                var world_arr = LookAt(mm, origin, target, up);
      ...
      SOUNDS: {
        "sound-water-1": {
          path: "3d/sound/water-dripping-1.mp3",
          volume: 0.65,
          loop: true,
        },
        "sound-item-pickup-1": {
          path: "3d/sound/item-pickup-1.mp3",
          volume: 1.0,
          loop: false,
        },

        "sound-door-creak-1": {
          path: "3d/sound/door-creak-1.mp3",
          volume: 0.5,
          loop: false,
        },

        "water-step-1": {
          path: "3d/sound/water-step-11.mp3",
          volume: 0.26,
          loop: false,
        },
        "water-step-2": {
          path: "3d/sound/water-step-12.mp3",
          volume: 0.26,
          loop: false,
        },
        "water-step-3": {
          path: "3d/sound/water-step-13.mp3",
          volume: 0.26,
          loop: false,
        },
        "water-step-4": {
          path: "3d/sound/water-step-14.mp3",
          volume: 0.26,
          loop: false,
        },
      },
    ...
    TXT: {
      ...
      gameover: [
        [
          "You try to run away but the dark thick waters slow you down...",
      ...
      items: ["Picked up item.", "Cannot use this item here."],
        ...
        [
          {
            ...
            options: [{ text: "Run" }, { text: "Stay still" }],
          },
        ],
      ...
      intro: [
        {
          title: "The Sewers",
          body: [
            "Your fall halts swiftly as you land in a puddle of putrid water.",
