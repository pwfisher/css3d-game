(function (w, d, GAME) {
      ...
      geom: [
        {
          ...
          shape_args: [
            new Vector(0, 250, 0),
            new Vector(0, 250, -160),
            new Vector(-180, 250, 0),
          ],
        },

        {
          ...
          shape_args: [
            new Vector(0, 250, -160),
            new Vector(0, 250, -500),
            new Vector(-500, 680, -500),
          ],
        },
      ...
      geom: [
        {
          ...
          img: "3d/level-06/dirt-ground-1.jpg",
          shape_args: [
            new Vector(-750, 250, 300),
            new Vector(-920, 250, 300),
            new Vector(-750, 250, 500),
          ],
        },
...

        {
          ...
          shape_args: [
            new Vector(-920, 250, 300),
            new Vector(-1250, 250, 300),
            new Vector(-1250, -150, 300),
          ],
        },
  ...
  var LEVEL = {
    ...
    PRELOAD: ["3d/caret-1.png", "3d/wall-dungeon_lossy.jpg"],
    MOVE: {
      rot: { x: -13, y: -90, z: 0 },
    ...
    MAP: {
      ...
      NODES: {
        ...
        "floor-3": {
          ...
          connected: [{ id: "floor-6", source: 3, target: 1 }],
        },
        "floor-4": {
          type: "dungeon-floor-1",
          connected: [
        ...
        "floor-6": {
          type: "dungeon-floor-1-h150",
          connected: [{ id: "wall-left-5", source: 2, target: 2 }],
        },
