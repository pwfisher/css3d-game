(function (w, d, GAME) {
  ...
  var LEVEL = {
    ...
    PRELOAD: ["3d/caret-1.png", "3d/level-2/wall-moss.png"],
    MOVE: {
    ...
    MAP: {
      ...
      NODES: {
        ...
        "floor-room-path-right-2": {
          type: "cave-water-2-h340",
          clss: "dirt",
          hide_frustrum: 1,
          hide_dist_max: 2200,
          beacon: ["2"],
        ...
        "wall-1": {
          type: "dungeon-wall-1",
          clss: "debug",
          connected: [{ id: "little-wall-1", source: 1, target: 3 }],
        },
